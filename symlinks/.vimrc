...
""acall pathogen#runtime_append_all_bundles()
...
"defaults for viminfo
set viminfo='100,f1,\"50,@25,:25,%

" allows to resize windows with mouse even in terminal vim
set mouse=a

" disable bell sound on MacVim
set vb
